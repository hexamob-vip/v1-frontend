...
export default function Header() {
  ...
  useEffect(() => {
    ...
    let scrollbarListener: ((status: { offset: { y: number } }) => void) | null = null;
  ...
  return (
    <>
    <div className={`${!scrolled ? "opacity-0" : "opacity-100"} pointer-events-none fixed top-0 left-0 w-full h-[50vh] -translate-y-full bg-white z-[999999] transition-all duration-300`}/>
      ...
      >
        ...
        >
          ...
          <div
            ...
            id="arrow-mobile-2"
          />
          <ul className="relative z-10 ml-[3vw] mt-[10vh] flex w-[94vw] list-none flex-col text-[120%] uppercase text-white max-lg:[&_li]:border-b max-lg:[&_li]:border-white max-lg:[&_li]:py-[2vw]">
            {navLinks.map((item) => (
              <li key={item.label}>
                <NavAnchor
                  href={item.href}
          ...
          <div className="group/reserve absolute bottom-0 left-0 flex items-center mb-[3vw] ml-[3vw] w-[94vw]">
          <HexamobButton
